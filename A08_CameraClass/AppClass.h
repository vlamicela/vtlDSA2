...
class AppClass : public ReEngAppClass
{
	...
	PrimitiveClass* m_pFloor = nullptr;

	//Voltron
	PrimitiveClass* lionB = nullptr;
	PrimitiveClass* lionY = nullptr;
	PrimitiveClass* lionR = nullptr;
	PrimitiveClass* lionG = nullptr;
	PrimitiveClass* lionK = nullptr;
	PrimitiveClass* voltron = nullptr;

	vtlCamera* m_vCam = nullptr;
	matrix4 m_m4Projection;
	matrix4 m_m4View;
	float camSpeed;
	int mouseX, mouseY, lastX, lastY, deltaX, deltaY;
public:
