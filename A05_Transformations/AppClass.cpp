...
#pragma region YOUR CODE GOES HERE
	float orbitE = 360; //rotation of Earth
	...
	//Make the Earth spin as it orbits the Sun (without messing with the Moon's orbit)
	m_m4Earth = glm::rotate(m_m4Earth, m_fEarthTimer * orbitE, vector3(0.0f, 0.0f, -1.0f));
